...
if __name__ == "__main__":
    ...
    with open('../wine.csv', mode='r') as wine_file:
        ...
        shuffle(wines) # dohvat linija podataka slučajnim slijedom
        for wine in wines:
    ...
    wine_network: Network = Network(layer_structure=[13, 20, 3],
                                    learning_rate=0.2,
                                    activation_function=sigmoid,  # postaviti drugu aktivacijsku funkciju
                                    derivative_activation_function=derivative_sigmoid  # i njenu derivaciju
                                    )
    ...
    # treniranje mreže nad prvih 150 vina 10 puta
    ...
    # testiranje nad zadnjih 28 vina u skupu podataka
