...
if __name__ == "__main__":
    ...
    with open('./flowers.csv', mode='r') as iris_file:
    ...
    iris_network: Network = Network(layer_structure=[4, 10, 3], #poigrati se s vrijednostima
                                    learning_rate=0.1,#poigrati se s vrijednosti learning_rate
